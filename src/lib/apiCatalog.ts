...
export const API_CATALOG: ApiEntry[] = [
  ...
  { group: 'Remote connection', tag: 'net', name: 'GetRemotePermission', topic: TOPICS.RM_CON, apiId: 1001, note: 'Reads whether internet remote connections are allowed.' },
  { group: 'Remote connection', tag: 'net', name: 'SetRemotePermission', topic: TOPICS.RM_CON, apiId: 1002, parameter: { enable_status: 2 }, note: '2 allows internet remote connections, 1 forbids them.' },
  ...
  { group: 'Motion switcher', tag: 'mode', name: 'SetSilent', topic: TOPICS.MOTION_SWITCHER, apiId: MOTION_SWITCHER_API.SET_SILENT, parameter: { silent: true }, note: 'Silent start: do not auto-start the sport service on boot.' },
  { group: 'Motion switcher', tag: 'mode', name: 'GetSilent', topic: TOPICS.MOTION_SWITCHER, apiId: MOTION_SWITCHER_API.GET_SILENT, note: 'Reads the silent-start flag.' },

  { group: 'Lights and sound', tag: 'vui', name: 'SetSwitch', topic: TOPICS.VUI, apiId: VUI_API.SET_SWITCH, parameter: { enable: 1 }, note: 'Master switch for the voice UI.' },
  { group: 'Lights and sound', tag: 'vui', name: 'GetSwitch', topic: TOPICS.VUI, apiId: VUI_API.GET_SWITCH, note: 'Reads the voice UI switch.' },
